...
const ActionMenu = ({ row, onView, onResolve }: ActionMenuProps) => {
                ...
                <div className="absolute right-0 mt-1 w-36 rounded-xl bg-white border border-gray-100 shadow-lg py-1.5 z-50 focus:outline-none">
                    ...
                    {row.status !== "resolved" && (
                        <button
                            ...
                            className="flex w-full items-center px-4 py-2 text-sm text-emerald-600 hover:bg-emerald-50 transition-colors"
                        >
                            Mark Resolved
                        </button>
                    )}
