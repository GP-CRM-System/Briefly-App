...
import { Linkedin01Icon, NewTwitterIcon, ViewOffSlashIcon, GoogleIcon, LockPasswordIcon } from "hugeicons-react";
            ...
            {showChangePassword ? (
                <div className="bg-white rounded-xl border border-gray-100 p-6 md:p-8 space-y-6 animate-fadeIn">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                        <span className="text-xs text-gray-400">Last changed: March 14, 2024</span>
